...
>Here is the code I made on Wavedrom-editor to generate the 1st timing diagram (Wavedrom is a JavaScript application, so this is very practical to use (as JSON objects).
